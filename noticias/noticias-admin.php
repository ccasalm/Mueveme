...
<body>
    <div class="container">
        ...
        require __DIR__ . '/auxiliar-admin.php';
        ...
        $sql .= " ORDER BY $orden $direccion LIMIT " . FPP
              . ' OFFSET ' . ($pag - 1) * FPP;
        $sent = ejecutarConsulta($sql, $execute, $pdo);
        dibujarTabla($sent, $nfilas, PAR, $orden,$direccion, $errores);
